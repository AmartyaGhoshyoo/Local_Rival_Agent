...
async def handle_ide_chat(request: IDEChatRequest):
    try:
        ...
        # Safely extract the data (handling whether your framework returns the raw instance or a dict)
        ...
        print("✅ [VS Code] Structured payload dispatched to extension.")
        return {
            "status": "success", 
            "reply": reply_text, 
            "new_code": new_code
